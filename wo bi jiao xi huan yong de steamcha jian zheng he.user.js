...
它解决什么问题？ Steam 愿望单默认只显示“当前价格”，但你不知道这价格是不是历史最低。这个脚本直接在游戏旁边给你亮出答案。

它长什么样、显示什么？ 在愿望单里，每个游戏右侧会多出一行字，例如： 史低 ¥22.1 -75% (2026-01-15)
...
额外功能（左上角切换国家）： 右上角有个下拉框，可以切换中国、日本、土耳其、美国、香港等地区，帮你比较不同区服的价格。比如某个游戏土耳其区史低只要 10 块钱，你可以心里有数（但注意跨区有风险）。

脚本二：进包标记（帮你判断“这游戏值不值钱”）
它解决什么问题？ 很多游戏会被塞进“慈善包”或“捆绑包”里贱卖过。一旦进过包，这个游戏以后就很难再卖出高价了。这个脚本直接给这种游戏打个“标签”，让你一眼识别。

它长什么样、显示什么？ 在 Steam 任何页面的游戏封面/卡片右上角，会出现一个黄色小标签，写着比如： 进过3包
...
它解决什么问题？ 你看到一个游戏很心动，但不知道要花多少时间才能通关。这个脚本直接从“HowLongToBeat”网站把平均通关时间拉过来，显示在 Steam 页面上。

它长什么样、显示什么？ 在 Steam 商店的购买按钮附近，会出现一块深色面板，上面显示四行数据：
...
它解决什么问题？ Steam 官方商店的价格不一定是最便宜的。SteamPy 是一个国内的第三方平台，可以买到“代购”或“CDK（激活码）”，价格有时候比 Steam 官方还便宜。这个脚本帮你一键对比并跳转购买。
